                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        if (item.getItemId() == R.id.customermainch) {
                            ...
                            Intent intent = new Intent(CustomerMenuActivity.this, CustomerBookActivity.class);
                            startActivity(intent);
                        } else if (item.getItemId() == R.id.customermenuch) {
                            Intent intent = new Intent(CustomerMenuActivity.this, CustomerMenuActivity.class);
                            startActivity(intent);
