                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        if (item.getItemId() == R.id.staffmainch) {
                            ...
                            Intent intent = new Intent(StaffBookActivity.this, StaffBookActivity.class);
                            startActivity(intent);
                        } else if (item.getItemId() == R.id.staffmenuch) {
                            Intent intent = new Intent(StaffBookActivity.this, StaffMenuActivity.class);
                            startActivity(intent);
                            ...
                            Intent intent = new Intent(StaffBookActivity.this, MainActivity.class);
                            startActivity(intent);
                        }
                        return true;
                    }
